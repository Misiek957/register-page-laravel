...
<x-layout>
    <header class="max-w-xl mx-auto mt-20 text-center">
        <h1 class="text-4xl">
            Cool <span class="text-blue-500">Eye-Catching</span> Title
        </h1>

        {{-- <h2 class="inline-flex mt-2">By Mike <img src="./images/lary-head.svg"
                ...
                <div class="flex-1 flex flex-col justify-between">
                    ...
                    <footer class="flex justify-between items-center mt-8">
                        ...
                        <div class="hidden lg:block">
                            <form method="POST" action="/like/{{$posts[0]->id}}">   
                                @csrf
                                <button type="submit"
